...
TR_NUM_CELLS_PAIRED_VJ_SPANNING_PROD_METRIC = {
    ...
    'description': 'Number of cell barcodes for which at least 1 sequence was found for each of TRA and TRB. Both sequences must have an annotated CDR3, must be predicted to be productive, and must span the beginning of the 5\' end of the V region to the 3\' end of the J region.',
    'format': 'integer',
}
...
FRAC_CELLS_VJ_SPANNING_METRIC = {
    ...
    'description': 'Fraction of cell-associated barcodes with at least one contig spanning the 5\' end of the V region and the 3\' end of the J region for %s.',
    'format': 'percent',
...
FRAC_CELLS_PRODUCTIVE_METRIC = {
    ...
    'description': 'Fraction of cell-associated barcodes with at least one contig that spans the 5\' end of the V region and the 3\' end of the J region for %s, has a start codon in the expected part of the V sequence, has an in-frame CDR3, and has no stop codons in the V-J region.',
    'format': 'percent',
    'prefix': 'canonical_vdj_genes_nomulti',
}
